...
public class FragmentFAQ extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        containerLinearLayout = (LinearLayout) view.findViewById(R.id.faq_container);
        setupFAQ(containerLinearLayout);
        return view;
    }

    private void setupFAQ(LinearLayout containerLinearLayout) {
        String[] faq = getResources().getStringArray(R.array.faq);
        String[] faqAnswers = getResources().getStringArray(R.array.faq_answer);
